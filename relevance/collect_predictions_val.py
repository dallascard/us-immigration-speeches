...
## Same as collect_predictions, but for the validation model trained on all data at once
...
def main():
    ...
    parser.add_option('--segments-pred-dir', type=str, default='data/speeches/Congress/segments_val_rel_preds/',
                      help='Directory with predictions for non-keyword segments: default=%default')
    ...
    parser.add_option('--outdir', type=str, default='data/speeches/Congress/predictions_val/',
    ...
    keyword_segment_probs1 = load_pred_probs(keywords_segments_file1 + '.relevance.tsv.tsv')
    ...
    keyword_speech_probs, keyword_segment_probs = update_keyword_speech_probs(keyword_speech_probs, keyword_segment_probs, keyword_segments1, keyword_segment_probs1, 43, 88)
    ...
    keyword_speech_probs, keyword_segment_probs = update_keyword_speech_probs(keyword_speech_probs, keyword_segment_probs, keyword_segments3, keyword_segment_probs3, 101, 108)
    keyword_speech_probs, keyword_segment_probs = update_keyword_speech_probs(keyword_speech_probs, keyword_segment_probs, keyword_segments4, keyword_segment_probs4, 109, uscr_transition-1)
