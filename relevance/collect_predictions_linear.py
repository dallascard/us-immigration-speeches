...
## Same as collect_predictions, but for the lienar model trained on all data at once
...
def main():
    ...
    parser.add_option('--uscr-segments-dir', type=str, default='data/speeches/Congress/uscr_segments/',
                      help='Directory with raw segments: default=%default')
    parser.add_option('--keywords-dir', type=str, default='data/speeches/Congress/keyword_segments_new/',
                      help='Directory with model predictions: default=%default')
    #parser.add_option('--keywords-pred-file', type=str, default='/u/scr/dcard/data/congress/keyword_segments_new/',
    #                  help='Directory with model predictions: default=%default')
    parser.add_option('--pred-dir', type=str, default='data/speeches/Congress/predictions_linear/relevance/exp/label/partition_v0.0_t0.0_s42/linear_f1_binarize_n2_l1/',
                      help='Directory with predictions for keyword and non-keyword segments: default=%default')
    ...
    parser.add_option('--outdir', type=str, default='data/speeches/Congress/predictions_linear/',
    ...
    keywords_segments_file1 = os.path.join(keywords_dir, 'keyword_segments_all.jsonlist')
    ...
    keywords_pred_file = os.path.join(pred_dir, 'pred.probs.keyword_segments_all.csv')
    ...
    keyword_segment_probs1 = load_pred_probs(keywords_pred_file)
    #keyword_segment_probs2 = load_pred_probs(keywords_segments_file2 + '.relevance.tsv.tsv')
    #keyword_segment_probs3 = load_pred_probs(keywords_segments_file3 + '.relevance.tsv.tsv')
    #keyword_segment_probs4 = load_pred_probs(keywords_segments_file4 + '.relevance.tsv.tsv')

    print("Counting speeches and getting max probs")
    keyword_speech_probs = {}
    keyword_segment_probs = defaultdict(dict)
    keyword_speech_probs, keyword_segment_probs = update_keyword_speech_probs(keyword_speech_probs, keyword_segment_probs, keyword_segments1, keyword_segment_probs1, 43, uscr_transition-1)
    #keyword_speech_probs, keyword_segment_probs = update_keyword_speech_probs(keyword_speech_probs, keyword_segment_probs, keyword_segments2, keyword_segment_probs2, 89, 100)
    #keyword_speech_probs, keyword_segment_probs = update_keyword_speech_probs(keyword_speech_probs, keyword_segment_probs, keyword_segments3, keyword_segment_probs3, 101, 103)

    uscr_keyword_speech_probs = {}
    uscr_keyword_segment_probs = defaultdict(dict)
    #uscr_keyword_speech_probs, uscr_keyword_segment_probs = update_keyword_speech_probs(keyword_speech_probs, keyword_segment_probs, keyword_segments3, keyword_segment_probs3, 104, 108)
    uscr_keyword_speech_probs, uscr_keyword_segment_probs = update_keyword_speech_probs(uscr_keyword_speech_probs, uscr_keyword_segment_probs, keyword_segments1, keyword_segment_probs1, uscr_transition, 116)
    ...
    #df['non_keyword_prob'] = [segment_speech_ids[imm_speech_ids[i]] for i in order]
...
def update_keyword_speech_probs(keyword_speech_probs, keyword_segment_probs, segments, yes_probs, first_congress, last_congress):
