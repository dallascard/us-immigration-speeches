...
def main():
    ...
    parser.add_option('--label', type=str, default='label',
                      help='Name of label field: default=%default')
    ...
    make_predictions(infile, outfile, train_file, model_type, model_name_or_path, tokenizer_name, max_seq_length, per_gpu, label_field)


def make_predictions(infile, outfile, train_file, model_type='roberta', model_name_or_path='roberta-base', tokenizer_name='', max_seq_length=512, per_gpu=4, label_field='label', overwrite_output_dir=True):
