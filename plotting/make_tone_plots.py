...
def main():
    ...
    with open(os.path.join(outdir, 'tone_data_by_congress.json'), 'w') as f:
        print(list(pro_imm_speeches_per_congress.keys()))
        print(list(anti_imm_speeches_per_congress.keys()))
        print(list(imm_speeches_per_congress.keys()))
        print(list(imm_speeches_per_congress_by_party.keys()))
        print(list(pro_imm_speeches_per_congress_by_party.keys()))
        print(list(anti_imm_speeches_per_congress_by_party.keys()))
        json.dump({
            'years': years,
