...
def main():
    ...
    parser.add_option('--infile', type=str, default='data/keyword-segments/keyword_segments_70-88.jsonlist',
                      help='Infile: default=%default')
    parser.add_option('--basedir', type=str, default='data/for_annotation_mid/rounds/',
